...
export default function Blog() {
  ...
  const list = posts.filter((p) => p.type === "blog");
  ...
  return (
    <section className="pt-32 pb-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl font-serif font-bold mb-4">{t("blog.title")}</h1>
          <p className="text-slate-400">{t("blog.subtitleWith")}</p>
        </motion.div>
            ...
            {list.map((post, index) => (
              ...
              >
                <Link to={`/blog/${post.slug}`}>
                  <Card className="glass border-gold-500/10 overflow-hidden group h-full flex flex-col">
                    <div className="relative h-48 overflow-hidden bg-slate-900">
                      ...
                      <div className="absolute top-4 left-4">
                        <Badge className="bg-gold-500 text-celestial-950 border-none">
                    ...
                    <CardHeader>
                      ...
                      <CardTitle className="text-xl font-serif text-gold-300 group-hover:text-gold-400">
                    ...
                    <CardContent className="flex-grow">
                      ...
                      <span className="inline-flex items-center gap-1 text-gold-400 text-sm font-medium mt-4 group/btn">
                        {t("blog.readMore")}
