      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold mb-8 leading-tight">
            Unlock Your <br />
            <span className="italic gold-gradient">Cosmic Destiny</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              ...
              className="bg-gold-500 hover:bg-gold-600 text-celestial-950 font-bold px-8 py-6 text-lg rounded-full transition-all hover:scale-105"
            >
              Book a Consultation
            </Button>
